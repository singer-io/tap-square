...
class TestSquareBaseParent:
    ...
    class TestSquareBase(ABC, TestCase):
        ...
        START_DATE = ""
        PRODUCTION_ONLY_STREAMS = {'roles', 'bank_accounts'} #{'roles', 'bank_accounts', 'settlements'}
        ...
        def create_test_data(self, testable_streams, start_date, start_date_2=None, min_required_num_records_per_stream=None, force_create_records=False):
            ...
            create_test_data_streams = list(testable_streams) #list(testable_streams) - {'roles'}
            testable_streams = list(testable_streams - {'roles'})
